...
export default {
  ...
  embeddingMaxRequestBytes: cfg.embeddingMaxRequestBytes ?? 262144,
  embeddingMaxCtxSize: cfg.embeddingMaxCtxSize ?? 8192,
  embeddingMaxBatchSize: cfg.embeddingMaxBatchSize ?? 3500,
  defaultEmbeddingBatchSize: cfg.defaultEmbeddingBatchSize ?? 2048,
  embeddingNoHost: cfg.embeddingNoHost ?? true,
  embeddingOpOffload: cfg.embeddingOpOffload ?? true,
  embeddingChunkSizeChars: cfg.embeddingChunkSizeChars ?? 6000,
  embeddingChunkOverlapChars: cfg.embeddingChunkOverlapChars ?? 200,
